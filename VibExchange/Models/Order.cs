...
namespace VibExchange.Models
{
    public class Order
    {
        ...
        [MaxLength(50,ErrorMessage="Please write only fifty words")]
    ...
    public class Enquiry
    {
        ...
        public string Enquiry_Cost { get; set; }
    ...
    // extra work//-----
   //public List<Enquiry> AlladminenquiryData()
   // {
   ...
   //   dt= context.getdata("Alladminenquiry", CommandType.StoredProcedure);
   //  foreach(DataRow dr in dt.Rows)
   // {
   //  enquiryList.Add(new Enquiry
   //  {
   //    EnquiryID = Convert.Tostring(dr["ID"]),
   //    UserName = Convert.ToString(dr["UserName"]),
   //    Enq_category = Convert.ToString(["EnquiryCategory"]),
   //    Enq_Subject = Convert.toString(["EnquirySubject"]),
   //    Enquiry Deatil1 = Convert.tostring(["EnquiryDetail"]),
   //    Enq_CreateDate = Covert.tostring(["CreateDate"]),
   //   Enquiry_Cost = Convert.Tostring(["Enquiry_Cost"]),
   //   Buyer_Name = Convert.tostring(["Buyer_Name"]),
   //   DateOfBuying =Convert.tostring(["DateOfBuying "]),
   //     });
   //  }
   // return enquiryList;
   // }
