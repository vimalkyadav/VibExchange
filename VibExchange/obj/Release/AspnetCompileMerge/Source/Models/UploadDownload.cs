...
namespace VibExchange.Models
{
    public class UploadFile
    {
        ...
        [Display(Name = "Bearing Manufacturer")]
        public string bearingMake { get; set; }

        [Display(Name = "Bearing No DE")]
        public string bearingNoDE { get; set; }

        [Display(Name = "Bearing No NDE")]
        public string bearingNoNDE { get; set; }

        [Display(Name = "Bearing No DE Input")]
        public string bearingDEIn { get; set; }

        [Display(Name = "Bearing No NDE Input")]
        public string bearingNDEIn { get; set; }

        [Display(Name = "Bearing No DE Output")]
        public string bearingDEOut { get; set; }

        [Display(Name = "Bearing No NDE Output")]
    ...
    public class UserPlans
    {
        ...
        public decimal Balance_point { get; set; }
    ...
    public class tblplans
    {
        ...
        [Display(Name = "TimeDuration")]
        public String TimeDuration { get; set; }
        [Display(Name = "AnalysisMethod")]
        public string AnalysisMethod { get; set; }
        [Display(Name = "Points")]
    ...
    public class usage
    {
        ...
        public decimal LastUsageDate { get; set; }
