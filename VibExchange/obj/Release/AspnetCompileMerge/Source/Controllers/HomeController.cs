...
namespace VibExchange.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult getUploadButtonStatus()
        {
            ...
            using (DBClass context = new DBClass())
            {
                DataTable dtBalance = context.getData("Select Balance_point from tblUserPlans where UserID = (Select [AutoId] from [UserDetail] where [UserName]='" + Session["UserName"].ToString() + "')", CommandType.Text);
