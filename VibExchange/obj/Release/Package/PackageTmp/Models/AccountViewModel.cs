...
namespace VibExchange.Models
{
    ...
    public class UserRegisterViewModel
    {
        ...
        [Display(Name = "Email ID(will be verified)")]
        ...
        [Display(Name = "Please enter your email verification pin")]
        [System.Web.Mvc.Remote("EmailverificationExit", "Home", HttpMethod = "POST", ErrorMessage = " Please Enter the valid email!")]
        ...
        public string ContactVerification { get; set; }
        ...
        //public bool TermsAndConditions { get; set; }	
        public List<UserRegisterViewModel> lstUser { get; set; }
    }
