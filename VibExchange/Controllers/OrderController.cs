...
namespace VibExchange.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        //public ActionResult AdminEnquiry()
        //{
        //    return View();
        //}

        //public ActionResult AdminEnquiry1()
        //{
        //    var Enq_List = Json(Enquiry.Alladminenquiry(Convert.ToString(Session["UserRole"])), JsonRequestBehavior.AllowGet);
        //    return Enq_List;
        //}

        //public ActionResult AdminEnquiryData(Enquiry enq)
        //{
        //    enq.enquiryList = enq.AlladminenquiryData();
        //    return PartialView("Adminpartial", enq.enquiryList);
        //}
